...
import arch.ether.IDataProducer
        ...
        if (triggerType != null) {
            val producerBuilder = TypeSpec.classBuilder(observablePublisherClassName)
                    ...
                    .addSuperinterface(ParameterizedTypeName.get(
                            ClassName(IDataProducer::class.java.`package`.name, IDataProducer::class.java.simpleName),
                    ...
                    .addFunction(FunSpec.builder("triggerObservable")
                            ...
                            .returns(ParameterizedTypeName.get(
                                    ClassName(Flowable::class.java.`package`.name, Flowable::class.java.simpleName),
                                    triggerType.asTypeName()
                            ))
                            .addStatement("return Ether.observableOf(%T::class.java)", triggerType.asTypeName())
            ...
            fileSpecBuilder.addStaticImport("arch.ether", "observableOf").addType(producerBuilder.build())
